...
func gpuCapableSurfaceCapabilities() -> WaylandGraphicsSurfaceCapabilities {
...
func softwareOnlySurfaceCapabilities() -> WaylandGraphicsSurfaceCapabilities {
    WaylandGraphicsSurfaceCapabilities(
        dmabuf: .unavailable,
        explicitSync: .unavailable,
        framePacing: .unavailable,
...
func testGraphicsSurfaceGeometry() throws -> SurfaceGeometry {
    try SurfaceGeometry(
