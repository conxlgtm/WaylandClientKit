    ...
    struct EGLRenderTargetTests {
        ...
        func gbmPlatformExtensionDetectionRequiresNamedExtension() {
            ...
            #expect(
                EGLGBMRenderTarget.supportsGBMPlatform(clientExtensions: "EGL_KHR_platform_gbm"))
            #expect(
                EGLGBMRenderTarget.supportsGBMPlatform(clientExtensions: "EGL_MESA_platform_gbm"))
            #expect(
