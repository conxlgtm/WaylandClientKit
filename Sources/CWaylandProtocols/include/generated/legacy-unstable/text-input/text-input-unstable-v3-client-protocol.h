...
struct zwp_text_input_v3_listener {
	 ...
	 * one modifies the pending state. This event replaces the current
	 ...
	 * inside preedit text. 7. Perform the requested action.
	 *
	 ...
	 * @param serial serial number of the action event
	 * @since 2
	 */
	 ...
	 *
	 * This event will be sent on creation if known and for all
	 * subsequent changes.
	 *
	 * The language should be specified as an IETF BCP 47 tag. Setting
	 * an empty string will reset any known language back to the
	 * default unknown state.
	 * @param language new language set by IME
	 * @since 2
	 */
	 ...
	 * pre-edit
	 *
	 * Notify of contextual hints for the pre-edit string. This event
	 * is always sent together with a zwp_text_input_v3.preedit_string
	 * event.
	 *
	 * The parameters start and end are counted in bytes relative to
	 * the beginning of the text buffer submitted through
	 * zwp_text_input_v3.preedit_string, and represent the substring in
	 * the pre-edit text affected by the hint.
	 *
	 * Multiple events may be submitted if the preedit string has
	 * different sections. The extent of hints may overlap. The parts
	 * of the preedit string that are not covered by any
	 * zwp_text_input_v3.preedit_hint event, the text will be
	 * considered unhinted. This is also the case if no preedit_hint
	 * event is sent.
	 *
	 * Clients should provide recognizable visuals to these hints. if
	 * they are unable to comply with this requisition, it may be
	 * preferable for them keep the preedit_shown content hint
	 * disabled.
	 *
	 * Values set with this event are double-buffered. They must be
	 * applied and reset on the next zwp_text_input_v3.done event.
	 * @param start starting point of the affected substring
	 * @param end end point of the affected substring
	 * @param hint hint to apply
	 * @since 2
	 */
	void (*preedit_hint)(void *data,
			     struct zwp_text_input_v3 *zwp_text_input_v3,
			     uint32_t start,
			     uint32_t end,
			     uint32_t hint);
...
#define ZWP_TEXT_INPUT_V3_SET_AVAILABLE_ACTIONS 8
#define ZWP_TEXT_INPUT_V3_SHOW_INPUT_PANEL 9
#define ZWP_TEXT_INPUT_V3_HIDE_INPUT_PANEL 10
 ...
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_ACTION_SINCE_VERSION 2
/**
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_LANGUAGE_SINCE_VERSION 2
/**
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_PREEDIT_HINT_SINCE_VERSION 2
 ...
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_SET_AVAILABLE_ACTIONS_SINCE_VERSION 2
/**
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_SHOW_INPUT_PANEL_SINCE_VERSION 2
/**
 * @ingroup iface_zwp_text_input_v3
 */
#define ZWP_TEXT_INPUT_V3_HIDE_INPUT_PANEL_SINCE_VERSION 2
 ...
 */
static inline void
zwp_text_input_v3_set_available_actions(struct zwp_text_input_v3 *zwp_text_input_v3, struct wl_array *available_actions)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v3,
			 ZWP_TEXT_INPUT_V3_SET_AVAILABLE_ACTIONS, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v3), 0, available_actions);
}
 ...
 */
static inline void
zwp_text_input_v3_show_input_panel(struct zwp_text_input_v3 *zwp_text_input_v3)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v3,
			 ZWP_TEXT_INPUT_V3_SHOW_INPUT_PANEL, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v3), 0);
}
 ...
 */
static inline void
zwp_text_input_v3_hide_input_panel(struct zwp_text_input_v3 *zwp_text_input_v3)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v3,
			 ZWP_TEXT_INPUT_V3_HIDE_INPUT_PANEL, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v3), 0);
}
