...
public struct ProtocolEntry: Codable, Sendable, Equatable {
    ...
    public var waylandClientKitTier: String
...
public struct ProtocolTooling {
    ...
    public func validateManifest() throws {
        ...
        for entry in manifest.protocols {
            ...
            if !tiers.contains(entry.waylandClientKitTier) {
                failures.append(
                    "\(entry.name) has invalid waylandClientKitTier: \(entry.waylandClientKitTier)")
            }
    ...
    public func verifyGenerated() throws {
        ...
        let generated = try fileSystem.createTemporaryDirectory(
            prefix: "wayland-client-kit-generated")
        defer {
            do {
