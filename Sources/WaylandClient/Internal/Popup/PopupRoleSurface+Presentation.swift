...
extension PopupRoleSurface {
    ...
    private func refreshMetadataCapabilitiesFromBoundGlobals() {
        ...
        surfaceRuntime.setContentTypeCapability(extensions.surfaceContentTypeCapability)
        surfaceRuntime.setAlphaModifierCapability(extensions.surfaceAlphaModifierCapability)
        surfaceRuntime.setTearingControlCapability(extensions.surfaceTearingControlCapability)
