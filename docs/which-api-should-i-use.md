...
| Submit a renderer-owned GPU buffer | `WaylandGraphicsFrameLease.submitExternalBuffer` with an external descriptor | `zwp_linux_dmabuf_v1` plus valid dmabuf plane descriptors | [External buffer docs](../Sources/WaylandGraphicsPreviewAPI/WaylandGraphicsPreview.docc/ExternalBufferSubmission.md) |
