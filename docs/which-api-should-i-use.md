...
| Inspect external GPU buffer preview evidence | `GraphicsPreviewExternalBufferSmoke -- --probe` | `zwp_linux_dmabuf_v1` advertisement; active import evidence uses maintainer-only plumbing | [External buffer docs](../Sources/WaylandGraphicsPreviewAPI/WaylandGraphicsPreview.docc/ExternalBufferSubmission.md) |
